  ...
  return (
    <footer className="py-20 border-t border-slate-900 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10 text-center md:text-left">
        ...
        <div data-reveal className="reveal reveal-delay-1 flex gap-4">
          <a
            target="_blank"
            href={import.meta.env.VITE_LINKEDIN}
            className="p-4 bg-slate-900 rounded-2xl hover:bg-slate-800 transition-all duration-300 text-slate-400 hover:text-white border border-slate-800 hover:-translate-y-1"
          >
            <Linkedin size={20} />
          </a>
          <a
      ...
      <div
        data-reveal
        className="reveal reveal-delay-2 max-w-6xl mx-auto mt-20 pt-8 border-t border-slate-900 text-center"
      >
